...
{
    /// <inheritdoc />
    public partial class UpdateStoredProcsForVisibility : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // 1. GetCordials - Main Timeline (ADDING VISIBILITY)
    ...
    ");
            ...
            // 2. GetCordialById - Details Page (ADD VISIBILITY)
            migrationBuilder.Sql(@"
    ...
    ");
            ...
            // 3. GetUserCordials - Profile “My Cordials” (add Visibility)
            migrationBuilder.Sql(@"
    ...
    ");
            ...
            // 4. GetUserCrownedCordials (profile “Crowned”) - add Visibility
            migrationBuilder.Sql(@"
    ...
    ");
            ...
            // 5. New Procedure - GetOnlyConnectionCordials
            migrationBuilder.Sql(@"
        CREATE PROCEDURE GetOnlyConnectionCordials
            @StartIndex INT,
            @PageSize INT,
            @CurrentUserId UNIQUEIDENTIFIER
        AS
